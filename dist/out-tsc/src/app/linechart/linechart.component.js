...
let LinechartComponent = class LinechartComponent {
    constructor() {
        this.countries = ["USA", "CAN", "MEX", "GBR", "DEU", "FRA", "KOR", "JPN", "IND"];
        this.wd_arr = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
        this.margin = { top: 50, right: 140, bottom: 50, left: 50 };
        this.width = 900 - this.margin.left - this.margin.right;
        this.height = 450 - this.margin.top - this.margin.bottom;
    }
    ngOnInit() {
        this.linedata = data.default;
...
], LinechartComponent.prototype, "redraw", null);
