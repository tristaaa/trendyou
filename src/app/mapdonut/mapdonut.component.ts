...
export class MapdonutComponent implements OnInit {
  ...
  donutdata = (data2 as any).default;
  ctydata = (data3 as any).default;
  piecolor = ["#d7301f","#6baed6","#fd8d3c","#c39bd3","#f7dc6f","#fee8c8"];
  topcat = ["Entertainment", "People & Blogs", "Music", "News & Politics", "Comedy","Others"];
  colorf = d3.scaleOrdinal()
      .domain(this.topcat)
      .range(this.piecolor)
  countries;
